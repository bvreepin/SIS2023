namespace UploadStudentConsoleApp
{
    ...
    internal partial class Program
    {
        internal sealed class ConsoleHostedService : IHostedService
        {
            ...
            private readonly IImporter _studentImporterService;
            ...
            public ConsoleHostedService(
                ...
                IImporter studentImporterService)
            {
                _logger = logger;
                _configuration = configuration;
                _appLifetime = appLifetime;
                _studentImporterService = studentImporterService;
            }
                    ...
                    Task.Run(async () =>
                    {
                        try
                        {
                            ...
                            */
                            ...
                            _studentImporterService.Import();
