namespace UploadAddressConsoleApp
{
    ...
    internal partial class Program
    {
        internal sealed class ConsoleHostedService : IHostedService
        {
            ...
            private readonly IImporter _addressImporterService;
            ...
            public ConsoleHostedService(
                ...
                IImporter addressImporterService)
            {
                _logger = logger;
                _configuration = configuration;
                _appLifetime = appLifetime;
                _addressImporterService = addressImporterService;
            }
                    ...
                    Task.Run(async () =>
                    {
                        try
                        {
                            ...
                            */
                            ...
                            _addressImporterService.Import();
