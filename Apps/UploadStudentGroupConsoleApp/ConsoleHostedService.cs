...
internal partial class Program
{
    internal sealed class ConsoleHostedService : IHostedService
    {
        ...
        private readonly IImporter _studentGroupImporterService;
        ...
        public ConsoleHostedService(
            ...
            IImporter studentGroupImporterService)
        {
            _logger = logger;
            _configuration = configuration;
            _appLifetime = appLifetime;
            _studentGroupImporterService = studentGroupImporterService;
        }
                ...
                Task.Run(async () =>
                {
                    try
                    {
                        ...
                        */
                        ...
                        _studentGroupImporterService.Import();
